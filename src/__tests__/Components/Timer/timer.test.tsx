...
describe('Timer', () => {
  ...
  it('renderiza el valor inicial del temporizador', () => {
    render(<Timer duration={10} onTimeout={() => {}} text="Tiempo restante: " />)
  ...
  it('llama a onTimeout cuando el temporizador llega a 0', () => {
    ...
    render(<Timer duration={3} onTimeout={onTimeoutMock} text="Tiempo restante: " />)
  ...
  it('actualiza el temporizador cada segundo', () => {
    render(<Timer duration={5} onTimeout={() => {}} text="Tiempo restante: " />)
